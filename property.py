...
class BakeJobSetting(bpy.types.PropertyGroup):
    ...
    color_depth: props.EnumProperty(items=get_valid_depths, name='Color Depth', default='8')
    color_mode: props.EnumProperty(items=get_valid_modes, name='Color Mode', default='RGBA')
